...
function OffenderModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" onClick={onClose}>
      ...
      {/* Modal */}
      <div
        className="relative bg-white shadow-2xl w-full h-full md:rounded-3xl md:max-w-5xl md:max-h-[92vh] overflow-hidden flex flex-col"
        onClick={(e) => e.stopPropagation()}
      >
        {/* ─── Red Alert Header ─── */}
        <div className="bg-gradient-to-r from-red-600 to-red-500 px-4 md:px-8 py-4 md:py-5 flex items-center justify-between shrink-0">
  ...
  if (loading) {
    return (
      <div className="min-h-screen p-4 md:p-6 lg:p-8 space-y-8">
        <div className="bg-gradient-to-br from-amber-500/10 via-yellow-500/5 to-transparent border border-gray-200/50 rounded-2xl p-5 md:p-8 lg:p-10">
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 tracking-tight mb-3">Alerts</h1>
